...
\begin{enumerate}
    ...
    \item \textbf{An evidence gap map of AI in geriatric nutrition} that systematically charts the translational landscape across application domains, study settings, and system maturity levels, providing a reusable methodological framework for identifying research priorities in emerging health informatics fields.
\end{enumerate}
